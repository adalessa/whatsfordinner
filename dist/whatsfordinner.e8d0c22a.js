...
exports.default = {
    data: function data() {
        return {
            eleccion: "",
            comidas: ["Pizza", "Milanesas", "Fideos", "Arroz"]
        };
    },

    methods: {
        choose: function choose() {
            this.eleccion = this.comidas[Math.floor(Math.random() * this.comidas.length)];
        }
    }
};
        var $dffb33 = exports.default || module.exports;
      
      if (typeof $dffb33 === 'function') {
        $dffb33 = $dffb33.options;
      }
    
        /* template */
        Object.assign($dffb33, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      ...
      _c(
        "button",
        {
          staticClass: "bg-blue rounded-full text-white py-2 px-4",
          on: { click: _vm.choose }
        },
        [_vm._v("Choose for me")]
      ),
      _vm._v(" "),
      _vm.eleccion
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dffb33', $dffb33);
          } else {
            api.reload('$dffb33', $dffb33);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/whatsfordinner.e8d0c22a.map